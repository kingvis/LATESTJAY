  ...
  return (
    <div className="py-16 md:py-24 overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-extrabold text-foreground tracking-tight mb-4">About <span className="text-secondary">Jay Music Academy</span></h1>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {FACULTY.map((member) => (
              <div key={member.name} className="text-center group">
                <div className="relative w-full aspect-square mx-auto rounded-lg overflow-hidden mb-4 border-2 border-transparent group-hover:border-secondary transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-secondary/20">
