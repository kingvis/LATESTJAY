            ...
            <div id="pricing" className="mx-auto w-full max-w-6xl space-y-12 px-4">
                ...
                <div className="relative space-y-12">
                    ...
                    >
                        ...
                        <div className="bg-background relative border p-6 rounded-xl shadow-lg">
                            <div className="space-y-1">
                                <div className="flex items-center justify-between">
                                    <h3 className="leading-none font-semibold">Professional Membership</h3>
                                    <Badge variant="outline">Teacher</Badge>
                                </div>
                                <p className="text-muted-foreground text-sm">Join our faculty and start earning.</p>
                            </div>
